...
- **Arquitectura de Datos:** Estructuración y limpieza de datasets para análisis específico.
- **Scripting:** Herramientas a medida para optimizar procesos y tareas automáticas.
